...
Current publication state: **FINAL DATABASE IMPORT AND CENSUS PASS; DOSSIER,
BOX, AND SITES CLOSEOUT IN PROGRESS**  
Current Box state: **JULY 28 TOWN-EXPANSION HANDOFF NOT REMOTELY VERIFIED**
...
- Final dossier generation, Box remote verification, and the next source-pinned
  Sites deployment remain publication work, not physical acceptance gates.
...
The database rebuild generated at `2026-07-28T21:20:11.565Z` passes SQLite
...
incidents, eleven recovery executions, sixteen QA defects, thirty-six
separately counted error occurrences, twenty-nine prevention rules, and 125
...
The KB separately records sixteen post-QA defects so they do not inflate or hide
...
- `QA-20260728-08` — open and nonfatal: the healthy Sites version 4 returns 404
  for `/favicon.ico`. Add and verify the favicon in the next exact deployment.
...
Only the citizen lifecycle follow-up and external publication closeout remain;
they must not be conflated with the accepted Town Expansion snapshot.
