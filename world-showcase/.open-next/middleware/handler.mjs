...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      async function bt(a10, b2) {
        ...
        return btoa(Array.from(new Uint8Array(await crypto.subtle.sign("HMAC", d2, c2.encode(a10))), (a11) => String.fromCharCode(a11)).join("")).replaceAll("+", "-").replaceAll("/", "_").replace(/=+$/, "");
      }
      async function bu(a10) {
        let b2 = process.env.SITE_SESSION_SECRET ?? "";
        if (!a10 || b2.length < 32) return false;
        let [c2, d2, e2, ...f2] = a10.split(".");
        if ("v1" !== c2 || f2.length > 0 || !/^\d+$/.test(d2 ?? "") || !e2) return false;
        let g2 = Number(d2);
        return !(!Number.isSafeInteger(g2) || g2 <= Math.floor(Date.now() / 1e3)) && await bt(`${c2}.${d2}`, b2) === e2;
      }
      async function bv(a10) {
        if (await bu(a10.cookies.get("mc_fleet_atlas_session")?.value) || "/" === a10.nextUrl.pathname) return S.next();
        let b2 = a10.nextUrl.clone();
        return b2.pathname = "/", b2.search = "", S.rewrite(b2);
      }
      ...
      let bw = { matcher: ["/((?!api/auth|_next/static|_next/image|favicon.ico|icon.svg).*)"] };
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api\\/auth|_next\\/static|_next\\/image|favicon.ico|icon.svg).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$"] }];
...
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/favicon.ico": { "initialHeaders": { "cache-control": "public, max-age=86400", "content-type": "image/svg+xml", "x-next-cache-tags": "_N_T_/layout,_N_T_/favicon.ico/layout,_N_T_/favicon.ico/route,_N_T_/favicon.ico" }, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/favicon.ico", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/icon.svg": { "initialHeaders": { "cache-control": "public, immutable, no-transform, max-age=31536000", "content-type": "image/svg+xml", "x-next-cache-tags": "_N_T_/layout,_N_T_/icon.svg/layout,_N_T_/icon.svg/route,_N_T_/icon.svg" }, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/icon.svg", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/_not-found": { "initialStatus": 404, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "29574abe0f463719fa4b18f1ec45df9f", "previewModeSigningKey": "6ca8e0f7a09543bfab61541e95754bb6d770bf2f6d1f11eb7a24f021285df37e", "previewModeEncryptionKey": "19877bb0e6d4857adb2ffd99f105c4e15e1092c518ed5e99a292c5189d27e03f" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/middleware.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api\\/auth|_next\\/static|_next\\/image|favicon.ico|icon.svg).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/((?!api/auth|_next/static|_next/image|favicon.ico|icon.svg).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "VFyEmgtnQnJ9Vq9M3uz90", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "JJYyzs+d8zFRyAPU35IvULYJePTL52Jn2c5fHseanmE=", "__NEXT_PREVIEW_MODE_ID": "29574abe0f463719fa4b18f1ec45df9f", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "6ca8e0f7a09543bfab61541e95754bb6d770bf2f6d1f11eb7a24f021285df37e", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "19877bb0e6d4857adb2ffd99f105c4e15e1092c518ed5e99a292c5189d27e03f" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/favicon.ico/route": "/favicon.ico", "/icon.svg/route": "/icon.svg", "/api/auth/route": "/api/auth", "/page": "/" };
var FunctionsConfigManifest = { "version": 1, "functions": { "/api/auth": {} } };
