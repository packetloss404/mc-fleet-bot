    ...
    <section id="technical">
      <div class="shell">
        ...
        <div class="approval" style="margin-top: 1.5rem">
          ...
          <p>G06 checks all ${g06Clearance.gate.exactNonNullG03DomainCount} exact G03 domains against ${g06Clearance.gate.generatedStartCount} generated starts and ${g06Clearance.gate.protectedCoreCount} protected cores in ${formatInteger(g06Clearance.gate.generatedStartDomainEvaluationCount + g06Clearance.gate.protectedCoreDomainEvaluationCount)} domain/subject evaluations. It finds the exact ${g06Clearance.gate.exactG03ProtectedCoreOverlapCellCount}-cell P1-B10 influence overlap with the shipwreck core, matching the separate D05 support finding. Positive expert margins, complete-save evidence, an accepted treatment contract, and final G06 acceptance remain HOLD.</p>
