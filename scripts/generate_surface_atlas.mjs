...
const activeAreas = [
  ...
  },
  {
    ...
    provenance: [
      'raven-rock/qa/build-log.md',
      'raven-rock/qa/portal-survey.md',
      'raven-rock/planning/coordinates.yaml',
  ...
  },
  {
    ...
    provenance: [
      'data/town.db',
      'worker-town/planning/site-plan.md',
      'docs/RAVENSREACH-CIVIC-QUARTER-2026-07-26.md',
...
const sourceEvidence = [
  ...
  'worker-town/planning/site-plan.md',
  'docs/RAVENSREACH-CIVIC-QUARTER-2026-07-26.md',
  'docs/MASTERPLAN-RAVENSREACH-PUBLIC-REALM.md',
  'raven-rock/qa/build-log.md',
  'raven-rock/qa/portal-survey.md',
  'raven-rock/planning/coordinates.yaml',
  'mainstreet-america/qa/audit-2026-07-26.md',
