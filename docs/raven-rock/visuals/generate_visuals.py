#!/usr/bin/env python3
"""
Generate docs/raven-rock/visuals/level-plans.svg and section.svg FROM planning/coordinates.yaml.
...
Usage
-----
    python3 docs/raven-rock/visuals/generate_visuals.py            # writes both SVGs
    python3 docs/raven-rock/visuals/generate_visuals.py --check     # exit 1 if output is stale
...
def footer(svg: Svg, generated_from: str) -> None:
    ...
    svg.text(
        40,
        y + 16,
        f"Generated by docs/raven-rock/visuals/generate_visuals.py from {generated_from} — do not hand-edit.",
        size=11,
        fill=C["muted"],
    )
