...
- **Reference:** `D:\projects\mc-fleet-bot\docs\masterplans\01-cheyenne-mountain-complex\04-design\site-plan.md` and `masterplan.pdf`. The chamber coordinates above are the *combined-complex placement*; the chamber geometry, spring layout, and J-curve internal detail live in the 01-masterplan.
...
- **Reference:** `D:\projects\mc-fleet-bot\docs\masterplans\02-subtropolis\04-design\site-plan.md` and `masterplan.pdf`.
...
- **Reference:** `D:\projects\mc-fleet-bot\docs\masterplans\03-houston-tunnel-system\04-design\site-plan.md` and `masterplan.pdf`.
