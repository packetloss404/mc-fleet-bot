...
**End of brief.** The companion `contractor-brief.json` is the machine-readable spec. Both files are at `D:\projects\mc-fleet-bot\docs\masterplans\04-combined-complex\04-contractor\map-integration\`.
