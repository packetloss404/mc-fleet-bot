...
The exact machine-readable bridge is `docs/masterplans/04-combined-complex/authority-reconciliation.json`.
...
- `docs/masterplans/04-combined-complex/AUTHORITY.md`
- `docs/masterplans/04-combined-complex/authority-reconciliation.json`

The child architectural authorities are:

- `docs/masterplans/01-cheyenne-mountain-complex/06-contractor/contractor-brief.json`
- `docs/masterplans/02-subtropolis/06-contractor/contractor-brief.json`
...
- **Subsequent owner-policy overlay (2026-08-06):** [the shipwreck removal authorization](phase1-shipwreck-removal-authorization.md) supersedes preserve-in-place only for attributable shipwreck fabric and authorizes controlled-removal engineering, not a world edit. The two igloos are unchanged. The shipwreck's 2,268-cell start bound and 1,118-cell present census remain evidence/search sets rather than deletion targets; exact attribution, three-chest salvage, desired states, technical treatment, rollback, and final manifest-bound authorization remain HOLD.
