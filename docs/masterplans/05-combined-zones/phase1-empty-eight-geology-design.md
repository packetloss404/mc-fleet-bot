# Phase 1 Empty Eight and geology decision
...
The terminal shell remains `x=1632…1872`, `Y=38…54`, `z=40…160`. The record now freezes a 14-material palette, the five-cell discovery datum, 8 platform/barrier schedules, 24 capped retail shells, two disjoint internal protected stair/lift core reservations, exact smoke-boundary openings, four internal ventilation reservations, 8 track drains and sumps, one capped discharge header, a fire/service spine, and 8 separately owned sealed east-stub contracts.
...
1. DESIGN CONTACT
2. Pikes Peak Granite analogue
3. Colorado batholith • about 1.1 billion years
4. Bethany Falls Limestone analogue
5. Upper Pennsylvanian • Missourian • Kansas City region
6. Architectural composite • not one natural outcrop
...
- [U.S. Geological Survey Publications Warehouse: Petrology and geochemistry of late-stage intrusions of the A-type, mid-Proterozoic Pikes Peak batholith (Central Colorado, USA): Implications for petrogenetic models](https://www.usgs.gov/publications/petrology-and-geochemistry-late-stage-intrusions-a-type-mid-proterozoic-pikes-peak) (1999).
- [U.S. Geological Survey: Preliminary Precambrian Basement Map of Colorado—A Geologic Interpretation of the Aeromagnetic Anomaly Map](https://pubs.usgs.gov/of/2001/ofr-01-0364/colo_of_text.html) (2001).
- [Kansas Geological Survey: Geology and Ground-Water Resources of Johnson County, Northeastern Kansas—Stratigraphy of Outcropping Rocks](https://www.kgs.ku.edu/General/Geology/Johnson/05_outcr.html) (1971).
- [Kansas Geological Survey: Carbonate Facies of the Swope Limestone Formation (Upper Pennsylvanian), Southeast Kansas](https://www.kgs.ku.edu/Publications/Bulletins/206_1/index.html) (1973).
