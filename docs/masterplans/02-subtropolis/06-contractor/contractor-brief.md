...
At each phase, compare the build to the closest reference in the visual-assets catalog (if available at `D:\projects\mc-fleet-bot\docs\masterplans\02-subtropolis\02-visuals\visual-assets.md`):
