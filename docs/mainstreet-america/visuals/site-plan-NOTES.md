...
- **Four Raven Rock portal-approach corridors** at the ±285 envelope edges, hatched RESERVED NO-BUILD
  (MSA OQ-7; Raven Rock OQ-1). Mouth coordinates from `docs/raven-rock/planning/coordinates.yaml`: N3 (−150, +285) — **relocated 2026-07-24, the drawings still show it at (0, +285)**,
