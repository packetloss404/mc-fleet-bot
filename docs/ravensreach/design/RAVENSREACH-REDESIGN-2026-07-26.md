...
Companion documents:
- `docs/ravensreach/design/MASTERPLAN-RAVENSREACH-PUBLIC-REALM.md` — roads, gardens, lighting, 7 build phases
- `docs/ravensreach/audits/ravensreach.yaml` — 37 repeatable checks; run with `scripts/audit.py`
...
(`docs/ravensreach/qa/INCIDENT-2026-07-25-ravensreach-structure-loss.md`) **was never whole.** The
