...
|---|---|---:|---|
| P1-B03 | ALL_AVAILABLE_EXACT_DOMAIN_BOUNDS_DISJOINT | — | no |
| P1-B07 | ALL_AVAILABLE_EXACT_DOMAIN_BOUNDS_DISJOINT | — | no |
| P1-B08 | ALL_AVAILABLE_EXACT_DOMAIN_BOUNDS_DISJOINT | — | no |
| P1-B09 | ALL_AVAILABLE_EXACT_DOMAIN_BOUNDS_DISJOINT | — | no |
| P1-B10 | ALL_AVAILABLE_EXACT_DOMAIN_BOUNDS_DISJOINT | — | no |
| D02 | ALL_AVAILABLE_EXACT_DOMAIN_BOUNDS_DISJOINT | — | no |
| D06-RESERVATIONS | UNKNOWN_DUE_NULL_CANONICAL_SCOPE_UNION | — | no |
| D06-MECHANISMS | UNKNOWN_DUE_NULL_CANONICAL_SCOPE_UNION | — | no |
| P1-B12 | EXACT_INTERSECTION_COMPILED | 4784 | no |

Known exact domain bounds are disjoint except P1-B12, which is intersected exactly above. 2 scope registry record(s) remain unknown because their canonical unions are null; unknown is not treated as empty.
